...
import TableEmptyRows from 'src/sections/employee/notice/table-empty-rows';
import NoticeTableRow from '../../../../sections/employee/notice/notice-table-row';
import NoticeTableHead from '../../../../sections/employee/notice/notice-table-head';
import NoticeTableToolbar from '../../../../sections/employee/notice/notice-table-toolbar';
import { emptyRows, applyFilter, getComparator } from '../../../../sections/employee/notice/utils';
            ...
            <TableBody>
              {dataFiltered.map((row) => (
                ...
                <NoticeTableRow
                  ...
                  onEdit={`/user/notices/${row.id}/edit`}
                  onView={`/user/notices/${row.id}/view`}
